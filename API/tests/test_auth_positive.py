...
class TestAuthAPIPositive:
    ...
    @allure.testcase('https://thankful-candy-c57.notion.site/PageObject-1c394f774aab8063bcd3f7d8e7652053')
    ...
    def test_login_as_admin(self, api_manager):
        login_as_admin_response = api_manager.auth_api.authenticate(UserDataForApiTests.get_admin_creds_for_authentication())
