...
class TestloginPage:
   ...
   def test_authenticate_by_ui(self, get_registered_user_data_from_request_of_registration_response, page):
      registered_user_data = get_registered_user_data_from_request_of_registration_response
