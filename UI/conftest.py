...
from UI.ui_tests_data.demoqa_data import DemoQaData
from UI.ui_tests_models.demo_qa_data_for_student_registration_model import DataForStudentRegistrationModel
